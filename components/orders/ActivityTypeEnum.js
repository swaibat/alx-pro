...
export const activityTypeEnum = {
  ...
  ORDER_CREATED: {
    ...
    description: 'The order has been created.',
    color: '#2196F3',
    icon: <ClockCountdown size={18} color="#2196F3" />,
  },
  PAYMENT_SUCCESS: {
  ...
  ORDER_SHIPPED: {
    ...
    color: '#2196F3',
    icon: <Truck size={18} color="#2196F3" />,
  },
  ORDER_DELIVERED: {
  ...
  REFUND_REQUESTED: {
    ...
    color: '#FF9800',
    icon: <ArrowCounterClockwise size={18} color="#FF9800" />,
  },
  REFUND_COMPLETED: {
    type: 'REFUND_COMPLETED',
    description: 'The refund has been completed.',
    color: '#4CAF50',
    icon: <CurrencyDollarSimple size={18} color="#4CAF50" />,
  },
}
