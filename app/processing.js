        ...
        <Layout style={{ flex: 1 }}>
            ...
            <View
                ...
                <View style={{ margin: 'auto', padding: 20 }}>
                    ...
                    <Text  style={{ color: theme['text-hint-color'], fontWeight: 'bold',display:'block', textAlign:'center' }}>
                            +256{msisdn}
                        </Text>
            ...
            <SafeAreaView style={{ width: '100%' }}>
                <View
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <Text style={{ marginLeft: 8, color: theme['text-hint-color'], textAlign: 'center' }}>
                            Secure payment
                        </Text>
                    </View>
                </View>
